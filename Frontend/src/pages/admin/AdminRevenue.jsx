            ...
            <div className="stats-grid" style={{ marginBottom: '32px' }}>
                <div className="glass-card stat-card">
                    ...
                    <div className="stat-details">
                        <span className="stat-value">{formatAmount(total)}</span>
                ...
                <div className="glass-card stat-card">
                    ...
                    <div className="stat-details">
                        <span className="stat-value">{formatAmount(deliveries)}</span>
                ...
                <div className="glass-card stat-card">
                    ...
                    <div className="stat-details">
                        <span className="stat-value">{formatAmount(maintenance)}</span>
                ...
                <div className="glass-card stat-card">
                    ...
                    <div className="stat-details">
                        <span className="stat-value">{formatAmount(support)}</span>
